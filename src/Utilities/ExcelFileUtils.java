...
public class ExcelFileUtils {
	...
	public ExcelFileUtils() throws Throwable {
		FileInputStream fi = new FileInputStream("E:\\selenium 2020\\Stockaccounting_DDF\\TestInput\\supplier.xlsx");
			...
			throws Throwable
	{
		...
		FileOutputStream fos=new FileOutputStream("./TestOutput/Hybrid.xlsx");
		wb.write(fos);
		fos.close();
	}
	}
